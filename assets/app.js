...
// Integração GPV V23.9.99dl — somente apresentação/navegação.
...
(()=>{
  ...
  if (topActions && !document.querySelector('[data-gpv-return]')) {
    ...
    a.className = 'nav-btn app-return-btn gpv-return-btn';
    a.href = inIt ? '../../index.html' : '../index.html';
    a.setAttribute('data-gpv-return','');
    a.textContent = '← App do Vistoriador';
    a.title = 'Voltar ao App do Vistoriador';
